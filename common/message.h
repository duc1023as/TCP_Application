...
struct message
{
	...
	{
		os << "ID:" << int(msg.header.id) << " Size:" << msg.header.size<< " Size File Name:" << msg.header.sizeOfFileName;
		return os;
	}
	...
	friend message<T>& operator << (message<T>& msg, const DataType& data)
	{
		...
		msg.header.sizeOfFileName = msg.fileName.size();
